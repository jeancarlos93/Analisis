<html>
    ...
    <body>   
        ...
        <nav>                       
            <ul>
                <li><a href="/Tienda-vachelle/tienda1.3/View/Listado_Usuarios.php">Usuarios</a></li>                   
                <li><a href="/Tienda-vachelle/tienda1.3/View/Listado_Proveedores.php">Proveedor</a></li>
                <li><a href="/Tienda-vachelle/tienda1.3/View/Cliente.php">Cliente</a></li>
                <li><a href="/Tienda-vachelle/tienda1.3/View/Listar_Productos.php">Productos</a></li>  
                <li><a href="/Tienda-vachelle/tienda1.3/Business/consultarInventario.php?buscarPor=4">Inventario</a></li>  
                <li><a href="#">Apartados</a></li> 
                <li><a href="#">Cuentas por pagar</a></li> 
                <li><a href="#">Ventas</a></li>
                <li><a href="#">Compras</a></li>
                <li><a href="#">Cierre de Caja</a></li>
                <li><a href="/Tienda-vachelle/tienda1.3/InicioSesion.php">Iniciar Sesion</a></li>  
            </ul>                         
        </nav>  
        <footer>
            Pie de la pagina
