       ...
       <br>
         <table id="Jtabla" cellpadding="0" cellspacing="0" border="0" class="display" >  
                ...
                for($i = 0; $i<count($usuario); $i++){
                    ...
                    echo '<td><a href= "../Business/eliminarUsuario.php?cedulaUsuario='.$usuario[$i]->getCedula().'" onclick="return confirmaEliminar()">'?><img src="../Image/delete.png" width="20px" height="20px"><?php echo'</a></td>'; 
